...
import 'package:vibe2/account/profile_screen.dart';
  ...
  void initState() {
    ...
    _pages = [
      HomeTab(
        ...
        nearYouController: nearYouController,
        isUser: isUser,
        isLoadingImage: _isLoadingImage,
        onToggleUser: (v) => setState(() => isUser = v),
...
class HomeTab extends StatelessWidget {
  ...
  final PageController nearYouController;
  final bool isUser;
  final bool isLoadingImage;
  final Function(bool) onToggleUser;
  ...
  const HomeTab({
    ...
    required this.nearYouController,
                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (context, i) {
                          ...
                          if (i == 0) {
                            ...
                            icon = Icons.place;
                            iconColor =
                                Colors.redAccent; // independently change color
                          } else if (i == 2) {
                            icon = Icons.star;
                            iconColor =
                                Colors.amber; // independently change color
                          } else {
                      ...
                      child: PageView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return AnimatedBuilder(
                            ...
                            child: _restaurantCarouselCard(context, index),
                          );
                        },
                      ),
                    ),
                      ...
                      child: PageView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return AnimatedBuilder(
                            ...
                            child: _nearYouCard(context, index),
                          );
                        },
                      ),
                    ),
  ...
  Widget _restaurantCarouselCard(BuildContext context, int index) {
    // card width is a portion of screen width (small horizontally)
    final double cardWidth = MediaQuery.of(context).size.width * 0.40;
  ...
  Widget _nearYouCard(BuildContext context, int index) {
              ...
              child: ClipRRect(
                ...
                child: SizedBox(
                  ...
                  child: Hero(
                    ...
                    child: Image.asset('assets/abc.png', fit: BoxFit.cover),
                  ),
                ),
              ),
            ),
